...
```bash
git clone git@github.com:ndang11/expense-tracker.git
cd expense-tracker
```
...
- Event handling and state management in a simple web app
...
- Add more detailed charts (trends over time, monthly comparisons)
